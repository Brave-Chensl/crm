...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#ActivityAndClue").click(function () {
        ...
        //给搜索框绑定键盘事件，敲回车，搜索并展现市场活动列表
        $("#activityName").keydown(function (event) {
            if (event.keyCode==13){
            var  message = $("#activityName").val()
				$.ajax({
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="relevanceBut" type="button" class="btn btn-primary">关联</button>
				</div>
			</div>
		</div>
	</div>
